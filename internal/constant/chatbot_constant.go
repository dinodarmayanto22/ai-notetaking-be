...
const (
	...
	DecideUseRAGMessageRawInitialUserPromptV1 = `You are a chatbot assistant that will answer your user
	question based on references provided. In this session, you will provide true or false data. True if
	you can answer directly without other information, false otherwise.`

	DecideUseRAGMessageRawInitialModelPromptV1 = `Okay, I understand. I will answer \"True\" if I can
	definitively answer the user's question based solely on my existing knowledge, and \"False\" if I
	cannot. I will not attempt to make educated guesses or provide potentially inaccurate information. I
	will wait for your question.\n`
)
